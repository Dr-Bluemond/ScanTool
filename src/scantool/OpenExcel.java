 ...
 * @author Bluemond
 */
public class OpenExcel extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpenExcel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
